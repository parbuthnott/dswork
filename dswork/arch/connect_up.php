...
function slideItem($title, $image, $number, $total)
{
    ...
    echo "  <img src='pictures/" . $image . "' alt='" . $title . "' style='width:100%' >";
...
{
    for ($n = 0; $n < $total; $n++) {
        echo "<span class='dot' id='dot" . ($n + 1) . "'></span>";
        echo "<script type='text/javascript'>";
        echo "  document.querySelector('#dot" . ($n + 1) . "').addEventListener('click', function (e) {";
        echo "    currentSlide(" . ($n + 1) . ");";
...
<head>
    ...
    $site = 'dsworkshop';
    ?>
    <title>www.dsworkshop.co.uk</title>
